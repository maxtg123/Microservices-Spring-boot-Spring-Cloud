* ![Global-architecture](diagrams/domain-class-diagram-global-architecture.drawio.png)
  <p style="font-size:20px;">Global architecture diagram</p>

* ![Class-diagram](diagrams/domain-class-diagram-class-diagram.drawio.png)
  <p style="font-size:20px;">Class diagram</p>

* ![Domain-class-diagram](diagrams/domain-class-diagram.drawio.png)
  <p style="font-size:20px;">Domain class diagram</p>

* ![Async-communication](diagrams/domain-class-diagram-async-communication.drawio.png)
  <p style="font-size:20px;">Async communication diagram</p>



<p style="font-size:30px;">Installation and configuration:</p>

* [Docker Desktop Installation Guide](https://docs.docker.com/desktop/install/windows-install)

* [Postgres Desktop ](https://www.postgresql.org/download/windows/)

* [MongoDB Desktop ](https://www.mongodb.com/docs/compass/current/install/)


<p style="font-size:15px;">Maven project structure to all pom.xml files of services</p>

<p style="font-size:15px;">Change all username + password accordingly</p>

<p style="font-size:15px;">start database and run database</p>
